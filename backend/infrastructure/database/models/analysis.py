...
class Analysis(Base, UUIDMixin):
    ...
    transcript: Mapped[dict | None] = mapped_column(
        "transcript", type_="JSON", nullable=True, default=None  # type: ignore[arg-type]
    )
    speakers: Mapped[dict | None] = mapped_column(
        "speakers", type_="JSON", nullable=True, default=None  # type: ignore[arg-type]
    )
    scenes: Mapped[list | None] = mapped_column(
        "scenes", type_="JSON", nullable=True, default=None  # type: ignore[arg-type]
    )
    topics: Mapped[list | None] = mapped_column(
        "topics", type_="JSON", nullable=True, default=None  # type: ignore[arg-type]
    )
    keywords: Mapped[list | None] = mapped_column(
        "keywords", type_="JSON", nullable=True, default=None  # type: ignore[arg-type]
    )
    emotions: Mapped[list | None] = mapped_column(
        "emotions", type_="JSON", nullable=True, default=None  # type: ignore[arg-type]
    )
    hooks: Mapped[list | None] = mapped_column(
        "hooks", type_="JSON", nullable=True, default=None  # type: ignore[arg-type]
    )
    chapters: Mapped[list | None] = mapped_column(
        "chapters", type_="JSON", nullable=True, default=None  # type: ignore[arg-type]
    )
    silences: Mapped[list | None] = mapped_column(
        "silences", type_="JSON", nullable=True, default=None  # type: ignore[arg-type]
    )
    quality_score: Mapped[int | None] = mapped_column(
        Integer, nullable=True, default=None
    )
    quality_details: Mapped[dict | None] = mapped_column(
        "quality_details", type_="JSON", nullable=True, default=None  # type: ignore[arg-type]
    )
